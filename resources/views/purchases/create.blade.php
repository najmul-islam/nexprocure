<x-app-layout>
    <x-breadcrumb :links="['Purchases' => route('purchases.index'), 'Add Purchase' => null]" />

    <div class="flex justify-between items-center py-3 ">
        <h2 class="my-4 text-3xl font-extrabold">Add Purchase</h2>
    </div>

    <div class="">
        <form action="{{ route('purchases.store') }}" method="POST" class="grid grid-cols-[2fr_1fr] gap-8">
            @csrf
            ...
            <div class="bg-white border rounded">
                ...
                {{-- Products Table --}}
                <div class="mb-3 p-4">
                    <table id="productTable" class="table w-full border">
                        <thead class="font-bold">
                            <tr>
                                ...
                                <th class="px-3 py-2 text-start">Total Price</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="px-3">
                                    <select name="product_id[]" class=" rounded border-gray-300 py-1" required>
                                ...
                                <td><input type="number" name="quantity[]" class="qty rounded border-gray-300 py-1"
                                        value="1" min="1" required></td>
                                <td><input type="number" name="unit_price[]" class="price rounded border-gray-300 py-1"
                                        value="0" min="0" required></td>
                                <td class="total px-3">0</td>
                                <td class="flex items-center gap-2 text-sm pr-3 pb-6">
                                    <button type="button" class="bg-red-600 py-1 px-2 rounded text-white delete-btn"
                        ...
                        <tfoot class="font-bold bg-gray-100 mt-3">
                            <tr class="">
                                <th class="px-3 text-center">Grand Total</th>
                                <th class="px-3 text-start" id="grandQty">0</th>
                                <th></th>
                                <th class="px-3 text-start" id="grandTotal">0.00</th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div class="bg-white border rounded">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-end gap-3 mt-4">
                        ...
                        <button type="submit"
                            class="px-3 py-1 bg-indigo-600 text-white rounded font-semibold hover:bg-indigo-500 transition-colors duration-200">Create
                            Purchase</button>
                    </div>
                </div>
            </div>
